...
# Thermal
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/thermal-engine-ali.conf:system/etc/thermal-engine-ali.conf
...
PRODUCT_COPY_FILES += \
    kernel/motorola/ali/drivers/staging/prima/firmware_bin/WCNSS_cfg.dat:$(TARGET_COPY_OUT_VENDOR)/firmware/wlan/prima/WCNSS_cfg.dat \
